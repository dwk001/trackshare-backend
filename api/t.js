            ...
            <div class="providers">
              ${track.providers.map(provider => {
                if (provider.name === 'spotify') {
                  return `
                    <button class="provider-btn ${provider.name}" onclick="openSpotify('${provider.deepLink}')">
                  ...
                  return `
                    <button class="provider-btn ${provider.name}" onclick="openAppleMusic('${provider.deepLink}')">
                  ...
                  return `
                    <button class="provider-btn ${provider.name}" onclick="openYouTubeMusic('${provider.deepLink}')">
