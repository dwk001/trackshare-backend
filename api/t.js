      ...
      res.send(`<!DOCTYPE html>
        ...
        <body>
          <div class="container">
            ...
            <div class="providers">
              ${track.providers.map(provider => {
                if (provider.name === 'spotify') {
                  return `
                    <button class="provider-btn ${provider.name}" onclick="openSpotify('${provider.deepLinkHint}', '${provider.webUrl}')">
                  ...
                  `;
                   ...
                   return `
                     <button class="provider-btn ${provider.name}" onclick="openMusicApp('${escapedDeepLink}', '${escapedWebUrl}')">
                       ${
            ...
            <script>
              function openSpotify(nativeUrl, webUrl) {
                console.log("Opening Spotify:", nativeUrl);
