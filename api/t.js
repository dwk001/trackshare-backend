          ...
          <div class="container">
            ...
            <div class="providers">
              ${track.providers.map(provider => `
                <button class="provider-btn ${provider.name}" onclick="openProvider('${provider.name}', '${provider.deepLinkHint.replace(/'/g, "\\'").replace(/"/g, '&quot;')}', '${provider.webUrl.replace(/'/g, "\\'").replace(/"/g, '&quot;')}')">
                  ${
            ...
            <script>
              function openProvider(provider, hintUrl, webUrl) {
