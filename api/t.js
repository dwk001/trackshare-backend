    ...
    if (trackData) {
      ...
      res.send(`
        ...
        <body>
          <div class="container">
            ...
            <div class="providers">
              ${track.providers.map(provider => `
                <a href="#" 
                   onclick="openProvider('${provider.name}', '${provider.deepLinkHint.replace(/'/g, "\\'")}', '${provider.webUrl.replace(/'/g, "\\'")}'); return false;" 
          ...
          <script>
            function openProvider(providerName, deepLink, webUrl) {
              // Detect Android
